...
class _PageCalendarState extends State<PageCalendar> {
  ...
  void _addMissionByDate(DateTime day, DateTime focusedDay) {
    showModalBottomSheet(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const StyledText.title('Calendar Traker')),
      body: content(),
    );
  }
